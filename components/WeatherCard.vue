<template>
  <div :class="['weather-container', theme]">
    <div class="weather-grid">
      <div class="weather-header fade-in-up">
        <h1>Weather</h1>
      ...
      <div class="weather-content" aria-live="polite">
        <div v-if="error" class="status error fade-in-up">
          <p>{{ error }}</p>
        </div>

        <div v-else-if="isLoading" class="status loading fade-in-up">
          <p>Loading weather...</p>
        </div>

        <div v-else-if="weather" class="weather-result fade-in-up">
        ...
        <div v-else class="status empty fade-in-up">
          <p>Search for a city to see the latest weather.</p>
        </div>
      </div>
    </div>

    <footer class="credits fade-in-up">
      <p>
        © 2025
        <a href="https://github.com/AkiraThyme" target="_blank" rel="noopener noreferrer">Jerold</a>
      </p>
    </footer>
  </div>
</template>
